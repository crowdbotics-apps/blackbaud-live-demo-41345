...
## Project Structure
    ...
    ├── blackbaud_live_demo_41345  # Django project configurations
...
1. Clone this repo and `cd blackbaud_live_demo_41345`
...
2. Clone this repo and `cd blackbaud_live_demo_41345`
